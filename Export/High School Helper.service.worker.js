...
/** @type {string} */
const CACHE_VERSION = '1728082888|161178512544';
/** @type {string} */
...
/** @type {string[]} */
const CACHED_FILES = ["High School Helper.html","High School Helper.js","High School Helper.offline.html","High School Helper.icon.png","High School Helper.apple-touch-icon.png","High School Helper.worker.js","High School Helper.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["High School Helper.wasm","High School Helper.pck"];
